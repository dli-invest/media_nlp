...
class YTNLP(NLPLogic):
    ...
    def find_matches(self, yt_transcript):
        ...
        for text_obj in yt_transcript:
            ...
            # set detailed_obj["ents"] to mapped doc.ents with label_ and text_
            # detailed_obj["ents"] = list(doc.ents)
            detailed_obj["ents"] = [{"label_": ent.label_, "text": ent.text} for ent in doc.ents]
            # simplify ents
    ...
    def make_report_complex(self, options=dict(), report_path="index.json"):
